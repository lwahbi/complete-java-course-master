...
/**
 *  OVERRIDDING                         |        OVERLOAING
 *  methode qre in different clqsses    |         methode qre in the sqme class
 * same : name, parameters, return type |        Same : nqme, different param and possible return type
 * perform in run time                  |        performed in compilqtion time
 *
 */
